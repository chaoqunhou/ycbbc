		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					...
					<li role="presentation"><a target = "_blank" href="http://www.youshengxian.com">Niushop开源商城官网</a></li>
					<li role="presentation"><a target = "_blank" href="http://www.youshengxian.com/forummain.html">访问论坛</a></li>
				</ul>
				<img src="?res=logo" />
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a  target = "_blank" href="http://www.youshengxian.com">Niushop开源商城官网</a> &nbsp; &nbsp; <a  target = "_blank" href="http://www.youshengxian.com/forummain.html">Niushop开源商城论坛</a> &nbsp; &nbsp; <a target = "_blank" href="http://www.youshengxian.com/authorization.html">购买授权</a>
				</div>
				<div class="text-center">
					Powered by <a   target = "_blank" href="http://www.youshengxian.com"><b>Niushop开源商城</b></a> v1.0 B2C公测版 &copy; 2015-2025 <a target = "_blank" href="http://www.youshengxian.com">www.youshengxian.com</a>
				</div>
			</div>
		</div>
