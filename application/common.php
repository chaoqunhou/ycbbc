 ...
 */
function elog($data,$name='data',$file_name='elog')
{
	error_log("\n[{$name}] @".date('Y-m-d H:i:s')." ============\n".var_export($data,1),
		3,
		ROOT_PATH."/data/{$file_name}.log");
}
//返回一个Json字符串
function returnJson($data, $code = 200 , $msg = 'succ')
{
...
function mkdir_p($dir, $dirmode = 493)
{
